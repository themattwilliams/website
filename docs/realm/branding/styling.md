...
<details>
  ...
  With this styling, `<h2>` elements on the page have green text.
  However, because class is a more specific selector, that style is overridden and the text is yellow.
