...
<details>
<summary>
Excerpt from the OpenAPI 3.1 specification about the Discriminator Object
</summary>
...
Read [how to use the discriminator](https://redocly.com/docs/resources/discriminator/) (it has visual examples).
...
```mermaid
erDiagram
          Schema ||..o| Discriminator : has
          Discriminator ||..o| DiscriminatorMapping : has
```
